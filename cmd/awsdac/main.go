...
import (
	...
	mcpserver "github.com/awslabs/diagram-as-code/internal/mcp"
...
func main() {
	...
	rootCmd.PersistentFlags().BoolVarP(&useMcp, "mcp", "", false, "Run MCP server mode")
